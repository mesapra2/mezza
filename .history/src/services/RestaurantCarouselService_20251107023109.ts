...
// ✅ CORREÇÃO FINAL: O nome correto da tabela é 'event_photos', 
// conforme confirmado na lista do seu banco de dados.
...
class RestaurantCarouselServiceClass {
  ...
  async uploadCarouselPhoto(
    ...
    try {
      ...
      // Criar registro no banco - USO DA TABELA CORRIGIDA
