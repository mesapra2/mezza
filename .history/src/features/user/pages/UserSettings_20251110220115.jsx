...
import { LogOut, Loader, Lock, Trash2, User, Phone, MapPin, Save, Edit, Check, X, Mail, Calendar, Shield, Gift, Users2 } from 'lucide-react';
  ...
  const loadUserData = async () => {
    ...
    try {
      const { data, error } = await supabase
        .from('profiles')
        .select('full_name, username, bio, phone, phone_verified, public_profile, allow_pokes, is_verified')
        .eq('id', user.id)
        .single();
        
      // Buscar status de verificação separadamente
