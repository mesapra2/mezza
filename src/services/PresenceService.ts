...
class PresenceService {
  ...
  static calculateStatus(lastSeen: string): PresenceStatus {
  ...
  static getStatusColor(status: PresenceStatus): string {
    const colors = {
      online: 'bg-green-500',
      away: 'bg-yellow-500',
      offline: 'bg-gray-500',
  ...
  static getStatusLabel(status: PresenceStatus): string {
    const labels = {
      online: 'Online',
      away: 'Ausente',
      offline: 'Offline',
